...
export default function Soal() {
    ...
    const handleNext = async () => {
        if (checkRepeatedAnswers()) {
            await handleAddHistory(); //simpan walaupun jawaban sama > 3x
            setShowResult(true);
    ...
    return (
        <div className="lg:w-1/2 mt-32 lg:mt-0 flex flex-col space-y-6">
            ...
            {!showResult ? (
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 text-center max-h-72 overflow-auto">
                    <h2 className="text-2xl text-gray-100">Hasil Diagnosis</h2>
                    <div className="p-4">
                        <h3 className="text-xl font-semibold">
                            Solusi yang Disarankan
                        </h3>
                        <ul className="mt-3 text-white space-y-2 text-left text-sm">
